...
const Footer = () => {
  const [showNaCurPanel, setShowNaCurPanel] = useState(false);

  const toogleNaCurPanel = () => {
    setShowNaCurPanel(!showNaCurPanel);
  };
      ...
      <div className={Styles.container}>
        ...
        <div className={Styles.support}>
          <div className={Styles.supporttext}>
            ...
            <p>
              <a>Carreira e Empregos</a>
            </p>
          </div>
          <div className={Styles.supporttext}>
            <h5>Ajuda</h5>
            <p>
              <a>Suporte de vendas</a>
            </p>
            <p>
            ...
            <p>
              <a>Trocas e Reembolso</a>
            </p>
          </div>
          <div className={Styles.supporttext}>
            <h5>Negócios</h5>
            <p>
              <a>Central de Negócios</a>
            </p>
            <p>
          ...
          <div className={Styles.supporttext}>
            ...
            <div>
              <a className={Styles.icon_facebook}>
                <i className="fa fa-facebook"></i>
              </a>
              <a className={Styles.icon_twitter}>
                <i className="fa fa-twitter"></i>
              </a>
              <a className={Styles.icon_instagram}>
                <i className="fa fa-instagram"></i>
              </a>
            </div>
            <div>
              <a className={Styles.icon_youtube}>
                <i className="fa fa-youtube-play"></i>
              </a>
              <a className={Styles.icon_linkdin}>
                <i className="fa fa-linkedin"></i>
              </a>
              <a className={Styles.icon_pinterest}>
        ...
        <div className={Styles.copyright}>
          <p>
            ...
            <span>Termos e Condições</span> e da{" "}
            <span>Política de Privacidade.</span>
          </p>
          <p>
            Todos os direitos autorais, marcas comerciais, marcas de serviço
