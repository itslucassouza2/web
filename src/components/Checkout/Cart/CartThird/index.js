...
const CartThird = () => {
  return (
    <CatalogStyle>
      <div className={Styles.config_panel_left} style={{}}>
        {/* <Accordion className={Styles.my_accordion}>
          ...
          <AccordionDetails>
            <Typography>
              ...
              e ele receberá no email o código com uma mensagem especial escrita
              por você!
              <input
                className={Styles.accordion_input}
                placeholder="Insira aqui o email do presenteado"
              ></input>
              <textarea
                className={Styles.accordion_textarea}
