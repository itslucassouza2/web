        ...
        <div className={styles.loginwrap}>
          ...
          <div className={styles.logincontent}>
            <div className={styles.interest} style={animationStyle}>
              <dl>
                <dt>Escolha seus interesses</dt>
                <dd>
                  Nós gostaríamos de entender seus gostos para te entregar
                  conteúdo e promoções exclusivas.
                </dd>
              </dl>
              <div className={styles.interest_check_wrap}>
                <div className={styles.row}>
                  {this.state.items?.map((el) => (
                    ...
                    >
                      ...
                      {el.name}{" "}
                      <i
                        className={"fa fa-" + (el.active ? "check" : "times")}
                      ></i>
                    </span>
                  ))}
                </div>
